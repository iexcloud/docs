...
Apperate includes curated, institutional-grade time series financial data ([Core Data](./getting-financial-data.md)). It is available as datasets for accessing via REST API endpoints and using with views.
